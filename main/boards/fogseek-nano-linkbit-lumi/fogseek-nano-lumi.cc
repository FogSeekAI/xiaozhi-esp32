...
#define TAG "FogSeekNanoLinkBitLumi"

class FogSeekNanoLinkBitLumi : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoLinkBitLumi *>(arg);
...
DECLARE_BOARD(FogSeekNanoLinkBitLumi);