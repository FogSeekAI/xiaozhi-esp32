...
//#define AUDIO_I2S_GPIO_MCLK GPIO_NUM_38 // 主时钟3.4

#define AUDIO_I2S_GPIO_MCLK GPIO_NUM_9 // 主时钟2.2
...
//#define AUDIO_CODEC_PA_PIN GPIO_NUM_41                    // NS4150B功放使能引脚3.4
#define AUDIO_CODEC_PA_PIN GPIO_NUM_38                    // NS4150B功放使能引脚2.2
...
#define LCD_BL_GPIO GPIO_NUM_42    // Backlight
// #define LCD_IM0_GPIO GPIO_NUM_43  // IM0
// #define LCD_IM2_GPIO GPIO_NUM_44  // IM2
#define LCD_IM0_GPIO GPIO_NUM_44  // IM0nano2.2
#define LCD_IM2_GPIO GPIO_NUM_43  // IM2nano2.2
...
//#define LCD_RESET_GPIO GPIO_NUM_40 // RSTnano2.2
