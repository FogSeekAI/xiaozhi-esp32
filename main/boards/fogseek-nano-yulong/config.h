...
#define VOLUME_BUTTON_GPIO GPIO_NUM_42
// 电源相关配置
...
// LCD 屏幕相关配置
#define BOARD_LCD_TYPE DISPLAY_TYPE_JYC_2_01_INCH // LCD 屏幕类型
...
#define DISPLAY_SPI_CS_GPIO GPIO_NUM_8    // CS
#define LCD_DC_GPIO GPIO_NUM_40   // DC
#define LCD_RESET_GPIO GPIO_NUM_5 // RST
#define LCD_BL_GPIO GPIO_NUM_1 
