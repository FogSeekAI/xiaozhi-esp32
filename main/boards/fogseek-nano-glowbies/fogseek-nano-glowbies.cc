...
#define TAG "FogSeekNanoGlowbies"

class FogSeekNanoGlowbies : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoGlowbies *>(arg);
...
public:
    FogSeekNanoGlowbies() : boot_button_(BOOT_BUTTON_GPIO),
...
DECLARE_BOARD(FogSeekNanoGlowbies);