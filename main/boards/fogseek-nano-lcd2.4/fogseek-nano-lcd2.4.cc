...
#define TAG "FogSeekNanoLcd2_4"

class FogSeekNanoLcd2_4 : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void InitializeDisplayManager()
    {
        lcd_pin_config_t lcd_pin_config = {
            ...
            // ST7789面板驱动接口
            .spi_dc_gpio = DISPLAY_SPI_DC_GPIO,
            .spi_reset_gpio = DISPLAY_RESET_GPIO,
            .spi_bl_gpio = DISPLAY_BL_GPIO,
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoLcd2_4 *>(arg);
...
public:
    FogSeekNanoLcd2_4() : boot_button_(BOOT_BUTTON_GPIO), ctrl_button_(CTRL_BUTTON_GPIO)
    {
        InitializeI2c();
...
DECLARE_BOARD(FogSeekNanoLcd2_4);
