...
#define TAG "FogSeekNanoLinkBitLumi4G"

class FogSeekNanoLinkBitLumi4G : public DualNetworkBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekNanoLinkBitLumi4G *>(arg);
...
public:
    FogSeekNanoLinkBitLumi4G() : DualNetworkBoard(ML307_TX_PIN, ML307_RX_PIN),
...
DECLARE_BOARD(FogSeekNanoLinkBitLumi4G);