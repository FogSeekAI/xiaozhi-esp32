...
#define TAG "FogSeekTrialES8311Lcd1_8"

class FogSeekTrialES8311Lcd1_8 : public WifiBoard
{
private:
    Button boot_button_;
    Button ctrl_button_;
    ...
    void HandleAutoWake()
    {
        ...
        else
        {
            ...
            {
                auto instance = static_cast<FogSeekTrialES8311Lcd1_8 *>(arg);
...
public:
    FogSeekTrialES8311Lcd1_8() : boot_button_(BOOT_BUTTON_GPIO), ctrl_button_(CTRL_BUTTON_GPIO)
    {
        InitializeI2c();
...
DECLARE_BOARD(FogSeekTrialES8311Lcd1_8);