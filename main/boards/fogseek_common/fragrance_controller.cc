...
void FragranceController::SetStressReliefModeParams()
{
    active_duration_ = 3000; // 3秒活跃时间
    cycle_duration_ = 10000; // 30秒周期
    //motor_controller_.RunMotorTimed(active_duration_);
